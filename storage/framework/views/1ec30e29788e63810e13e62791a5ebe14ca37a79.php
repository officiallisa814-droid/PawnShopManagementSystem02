...
<?php $__env->startPush('styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin_css/pawnItem.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pawn-container">
        ...
        <div class="pawn-card">
            ...
            <form action="<?php echo e(route('pawnItems.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
        ...
        <div class="pawn-card table-card">
            ...
            <div class="responsive-table-wrapper">
                <table class="inventory-table" id="inventory_data_table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $pawnItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr onclick="window.location='<?php echo e(route('pawnItem.show', $item->id)); ?>'" style="cursor: pointer;"
                                ...
                                <td onclick="event.stopPropagation();">
                                    <div style="display: flex; align-items: center; gap: 8px;">
                                        <?php if($item->customer && $item->customer->customer_avatar): ?>
                                            <img src="<?php echo e(asset('storage/' . $item->customer->customer_avatar)); ?>"
                                        ...
                                        <span class="khmer-os customer-name-td"
                                            style="font-weight: 600;"><?php echo e($item->customer->customer_name ?? 'N/A'); ?></span>
                                    </div>
                                </td>

                                <!-- Added a target class for the item name column string -->
                                <td class="item-name-td" style="color: #2563eb; font-weight: 600;"><?php echo e($item->item_name); ?></td>
                                <td><?php echo e(ucfirst($item->category)); ?></td>
                                <td><?php echo e($item->imei_serial_tag ?? $item->serial_number); ?></td>
                                <td><?php echo e($item->storage_location); ?></td>
                                <td style="font-weight: bold; color: #16a34a;">$<?php echo e(number_format($item->approved_loan, 2)); ?>

                                </td>
                                <td><?php echo e($item->monthly_interest_rate ?? $item->interest_rate); ?>%</td>
                                <td><?php echo e($item->pawn_date); ?></td>
                                <td style="color: #ef4444; font-weight: 600;"><?php echo e($item->maturity_due_date ?? $item->due_date); ?>

                                </td>
                                <td>
                                    <span
                                        style="padding: 4px 8px; border-radius: 12px; font-size: 12px; background-color: #def7ec; color: #03543f; font-weight: bold;">
                                        <?php echo e(strtoupper($item->item_status ?? $item->status)); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PawnShopManagementSystemV02\resources\views/admin/pawnItem.blade.php ENDPATH**/ ?>